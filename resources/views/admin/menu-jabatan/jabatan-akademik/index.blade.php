                ...
                <div class="card">
                    ...
                    <div class="card-body card-dashboard ">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table_jabatan_akademik">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Periode</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="form-tambah-edit" name="form-tambah-edit">
                                                ...
                                                <div class="form-group">
                                                    <select class="select form-control" id="id_pegawai"
                                                        name="id_pegawai">
                                                        <option value="">Pilih</option>
                                                ...
                                                <div class="form-group">
                                                    <select class="select form-control" id="id_jabatan"
                                                        name="id_jabatan">
                                                        <option value="">Pilih</option>
                                                ...
                                                <div class="form-group">
                                                    <select class="select form-control" id="fakultas" name="fakultas">
                                                        <option value="">Pilih</option>
                                        ...
                                        <div class="modal-footer">
                                            <a href="{{ route('jabatan-akademik.index') }}" type="button"
...
<script>
    ...
    $('#tombol-tambah').click(function () {
        ...
        $('#modal-judul').html("Tambah Data Jabatan Akademik");
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('jabatan-akademik/' + data_id + '/edit', function (data) {
            $('#modal-judul').html("Form Edit Jabatan Akademik");

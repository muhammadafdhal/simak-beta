                ...
                <div class="card">
                    ...
                    <div class="card-body card-dashboard ">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table_prodi">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kode Prodi</th>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <fieldset class="form-group">
                                                            ...
                                                            <input type="text" name="kode_prodi"
                                                                ...
                                                                class="form-control"
                                                                id="kode_prodi" placeholder="Masukan Kode Prodi" />
                                                        ...
                                                        <fieldset class="form-group">
                                                            ...
                                                            <input type="text" name="kode_dikti"
                                                                value="{{ old('kode_dikti') }}"
                                                                class="form-control"
                                                                id="kode_dikti" placeholder="Masukan Kode Dikti" />
                                        ...
                                        <div class="modal-footer">
                                            <a href="{{ route('prodi.index') }}" type="button"
...
<script>
    ...
    $('#tombol-tambah').click(function () {
        ...
        $('#modal-judul').html("Form Tambah Prodi");
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('prodi/' + data_id + '/edit', function (data) {
            $('#modal-judul').html("Form Edit Prodi");

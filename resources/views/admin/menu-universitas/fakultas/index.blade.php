            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <button type="button" data-toggle="modal" data-target="#show-archived"
                            class="btn btn-icon btn-warning mr-1 mt-1" style="float: right;"><i data-toggle="tooltip"
                                title="Lihat Arsip" class="bx bx-archive"></i>
                        </button>
                ...
                <div class="card-body card-dashboard ">
                    <div class="table-responsive">
                        <table class="table table-striped" id="table_fakultas">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Periode</th>
                                    ...
                                    <div class="modal-body">
                                        <form id="form-tambah-edit" name="form-tambah-edit">
                                            ...
                                            <div class="form-group">
                                                <select class="select form-control" id="id_periode" name="id_periode">
